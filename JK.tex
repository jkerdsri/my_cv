...
\section{Experience}
  ...
  \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Principal Data Scientist}{Leading the core-data scientist team to make use of micro/granular data and alternative data (big data) to augment insights found from aggregated data through the use of artificial intelligence, machine learning, text processing, and network theory. }
