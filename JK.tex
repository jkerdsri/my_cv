...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Bank of Thailand}{Oct 2018 - Present}
      \resumeItemListStart
        \resumeItem{}
        ...
        \resumeItem{}
          ...
          \resumeItem{Data Architect}{involve with data engineering process, data strategic, and data pipeline to achieve the goal of data-driven organization.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {}{Jan 2019 - Present}
      \resumeItemListStart
        \resumeItem{Pro Technical Info Services Co.Ltd.}
          {Provide consultative guidance on deploying big data analytics concepts to project.}
         \resumeItem{ENergy SOLution (ENSOL)}{Provide consultative guidance on collecting and analyze IoT data from various sensors.} 
    \resumeItemListEnd 
    ...
    \resumeSubheading
      {Programmer}{Ministry of Defence}
      {Supreme Command Headquarters}{Mar 2003 - Jul 2009}
      \resumeItemListStart
        \resumeItem{}
